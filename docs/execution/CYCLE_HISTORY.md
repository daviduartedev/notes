...
|---|---|---|---|---|---|---|
| C0 foundation | done | Repo, harness, CI, shell, auth, workspace, `/hoje` vazio | sim | lint/typecheck/test/build 0 | `7d99a98` cycle(00): foundation | Large 4 stages; Postgres local :5433; push origin main ok |
