...
| C11 templates-de-workflow | done | CRUD templates (fecha roadmap) | sim | lint/typecheck/test/build 0 | `8a76103` | Sem Playwright; sem BPM; 6 seeds; create exige template |
