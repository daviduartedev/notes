# Janelas de contexto — C11 Templates de workflow
...
**Cycle ativo:** `cycles/Q32026/0818-c11-templates-de-workflow`
...
1. `AGENTS.md`
2. `cycles/README.md`
3. `cycles/Q32026/0818-c11-templates-de-workflow/request.md`
...
Executar **somente** o que está em `cycles/Q32026/0818-c11-templates-de-workflow/tasks.md` para o escopo acima.

Leia: `AGENTS.md`, `cycles/Q32026/0818-c11-templates-de-workflow/request.md`, `plan.md`, `tasks.md`, `scenarios.feature`, `implementation-notes.md`, specs citadas no plan.
...
Revisão **read-only**. Escreva `cycles/Q32026/0818-c11-templates-de-workflow/review.md`.
...
Rodar gates de verdade e preencher `cycles/Q32026/0818-c11-templates-de-workflow/validation.md`. Nada de ✅ sem executar.
...
Promova `cycles/Q32026/0818-c11-templates-de-workflow/spec-delta.md` para `spec/` **somente o que foi implementado e validado**.
...
- escrever `cycles/Q32026/0818-c11-templates-de-workflow/CLOSURE.md` (resumo, valor, o que o próximo cycle pode assumir)
