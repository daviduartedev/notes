# Janelas de contexto — C6 Aprovações
...
**Cycle ativo:** `cycles/Q32026/0818-c6-aprovacoes`
...
1. `AGENTS.md`
2. `cycles/README.md`
3. `cycles/Q32026/0818-c6-aprovacoes/request.md`
...
Executar **somente** o que está em `cycles/Q32026/0818-c6-aprovacoes/tasks.md` para o escopo acima.

Leia: `AGENTS.md`, `cycles/Q32026/0818-c6-aprovacoes/request.md`, `plan.md`, `tasks.md`, `scenarios.feature`, `implementation-notes.md`, specs citadas no plan.
...
Revisão **read-only**. Escreva `cycles/Q32026/0818-c6-aprovacoes/review.md`.
...
Rodar gates de verdade e preencher `cycles/Q32026/0818-c6-aprovacoes/validation.md`. Nada de ✅ sem executar.
...
Promova `cycles/Q32026/0818-c6-aprovacoes/spec-delta.md` para `spec/` **somente o que foi implementado e validado**.
...
- escrever `cycles/Q32026/0818-c6-aprovacoes/CLOSURE.md` (resumo, valor, o que o próximo cycle pode assumir)
