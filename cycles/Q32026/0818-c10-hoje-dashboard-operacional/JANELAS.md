# Janelas de contexto — C10 Hoje

**Pasta:** `cycles/Q32026/0818-c10-hoje-dashboard-operacional/`  
**Tipo:** Medium  
**Depende de:** C3–C9 fechados  
**Status:** `request.md` pronto → **Refine depois de C3–C9**
...
**Cycle ativo:** `cycles/Q32026/0818-c10-hoje-dashboard-operacional`
...
1. `AGENTS.md`
2. `cycles/README.md`
3. `cycles/Q32026/0818-c10-hoje-dashboard-operacional/request.md`
...
Executar **somente** o que está em `cycles/Q32026/0818-c10-hoje-dashboard-operacional/tasks.md` para o escopo acima.

Leia: `AGENTS.md`, `cycles/Q32026/0818-c10-hoje-dashboard-operacional/request.md`, `plan.md`, `tasks.md`, `scenarios.feature`, `implementation-notes.md`, specs citadas no plan.
...
Revisão **read-only**. Escreva `cycles/Q32026/0818-c10-hoje-dashboard-operacional/review.md`.
...
Rodar gates de verdade e preencher `cycles/Q32026/0818-c10-hoje-dashboard-operacional/validation.md`. Nada de ✅ sem executar.
...
Promova `cycles/Q32026/0818-c10-hoje-dashboard-operacional/spec-delta.md` para `spec/` **somente o que foi implementado e validado**.
...
- escrever `cycles/Q32026/0818-c10-hoje-dashboard-operacional/CLOSURE.md` (resumo, valor, o que o próximo cycle pode assumir)
