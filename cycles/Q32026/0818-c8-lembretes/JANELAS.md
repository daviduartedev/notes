# Janelas de contexto — C8 Lembretes

**Pasta:** `cycles/Q32026/0818-c8-lembretes/`  
**Tipo:** Medium  
**Depende de:** C1 e C2 fechados  
**Status:** `fechado` (C8, 19/08/2026)
...
**Cycle ativo:** `cycles/Q32026/0818-c8-lembretes`
...
1. `AGENTS.md`
2. `cycles/README.md`
3. `cycles/Q32026/0818-c8-lembretes/request.md`
...
Executar **somente** o que está em `cycles/Q32026/0818-c8-lembretes/tasks.md` para o escopo acima.

Leia: `AGENTS.md`, `cycles/Q32026/0818-c8-lembretes/request.md`, `plan.md`, `tasks.md`, `scenarios.feature`, `implementation-notes.md`, specs citadas no plan.
...
Revisão **read-only**. Escreva `cycles/Q32026/0818-c8-lembretes/review.md`.
...
Rodar gates de verdade e preencher `cycles/Q32026/0818-c8-lembretes/validation.md`. Nada de ✅ sem executar.
...
Promova `cycles/Q32026/0818-c8-lembretes/spec-delta.md` para `spec/` **somente o que foi implementado e validado**.
...
- escrever `cycles/Q32026/0818-c8-lembretes/CLOSURE.md` (resumo, valor, o que o próximo cycle pode assumir)
